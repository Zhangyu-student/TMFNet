...
from models.mamba_test import TemporalMambaFusionNet
...
if __name__ == "__main__":
    # 配置参数
    config = {
        "model_path": "./checkpoints/TMFNet_old.pth",
        "data_root": r"F:\SENMS_NEW\harvard_dataset\multipleImage",
        "save_dir": "./inference_results_old",
        "batch_size": 8,
